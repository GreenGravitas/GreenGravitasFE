          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
             <li>
               ...
               <li>
                <Link href="/Products" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">
                  Products
                </Link>
              </li>
              <li>
              ...
              <li>
               ...
               <li>
                <Link href="/aboutUs" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">
                  about Us
                </Link>
              </li>
            </ul>
